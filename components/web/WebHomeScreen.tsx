...
export function WebDiscoveryStage({
   ...
   * pinning and stealing the little height there is.
   */
  ...
  const stageWithControls = (children: React.ReactNode) =>
    stage(
      [styles.emptyStage, controls ? styles.emptyStageWithControls : null],
      <>
        {children}
        {controls ? (
          <View style={styles.controlsSlotEmpty}>{controls}</View>
        ) : null}
      </>
    );
